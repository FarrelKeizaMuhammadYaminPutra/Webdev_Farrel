...
const EmailVerificationPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      />
      <div className="max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter rounded-2xl shadow-xl overflow-hidden">
        <motion.div
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="bg-gray-800 bg-opacity-50 backdrop-filter  rounded-2xl shadow-2xl p-8 w-full max-w-md"
        >
